                        ...
                        <div class="card-body card-block">
                           <form method="post">
							   <div class="form-group">
									...
									<input type="text" value="<?php echo $name?>" name="name" placeholder="Enter employee name" pattern="[a-zA-Z'-'\s]*"  class="form-control" required>
								</div>
								<div class="form-group">
									<label class=" form-control-label">Email</label>
									<input type="email" value="<?php echo $email?>" name="email" placeholder="Enter employee email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control" required>
								</div>
								<div class="form-group">
									<label class=" form-control-label">Mobile</label>
									<input type="tel" value="<?php echo $mobile?>" name="mobile" placeholder="Enter employee mobile" pattern="[9]{1}[0-9]{3}[0-9]{6}" max=10 class="form-control" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="date" value="<?php echo $birthday?>" name="birthday" placeholder="Enter employee birthday" max="2010-12-31" class="form-control" required>
								</div>
